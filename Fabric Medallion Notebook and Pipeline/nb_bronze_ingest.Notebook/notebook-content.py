...
# MAGIC %%sql
# MAGIC EXEC sp_get_table_health_metrics @fact_dockets = 'LH_Logibuddy.gold.fact_dockets';
...
for table in table_names:
    try:
       ...
       df.write.format("delta").mode("overwrite").saveAsTable(f"dbo.bronze_{table}")
